...
export default function Home() {
  return (
    <Layout pageTitle="HomePage">
      <div className="px-4 flex flex-col items-center my-24 gap-6 md:gap-10 md:justify-center">
        ...
        <div className="bg-knicksBlue w-3/5 px-8 py-16 text-center md:mt-16 rounded-t-[60px] rounded-b-[210px]">
          ...
          <p className="text-4xl md:text-5xl">
            ...
            about movies, series, that I am use to spread around me...
          </p>{" "}
          <br />
